...
import SearchPropertiesList from "@/components/SearchPropertiesList";
...
export default function Properties() {
  ...
  const searchParams = {
    transacaoId: String(params.transacaoId),
    cityId: String(params.cityId),
    categoryId: String(params.categoryId),
    qtdQuartos: String(params.qtdQuartos),
    qtdVagasGaragem: String(params.qtdVagasGaragem),
  };
      ...
      <div className="w-full h-full flex items-center justify-center py-10 bg-[#EBF0F6]">
        <section className="w-full flex-col flex items-center justify-center max-w-[1200px]">
          ...
          <SearchPropertiesList
            transacaoId={searchParams.transacaoId}
            cityId={searchParams.cityId}
            qtdQuartos={searchParams.qtdQuartos}
            qtdVagasGaragem={searchParams.qtdVagasGaragem}

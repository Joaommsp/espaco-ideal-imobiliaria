...
import { getSearchProperties } from "../lib/services/api-service";
...
export default function SearchPropertiesList(props: SearchPropertiesProps) {
  ...
  async function getPropertiesData() {
    const propertiesData = await getSearchProperties(
      props.transacaoId,
      props.cityId,
      props.categoryId,
      props.qtdQuartos,
      props.qtdVagasGaragem
    );
